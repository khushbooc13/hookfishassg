...
<body>
Welcome <?php echo $login_session; ?>! Have A Great Day! <br> <!-- display user name  via variable $login_session -->
<a href="addUser.php"><input type="submit" id="submit" value="Add User"></a>
